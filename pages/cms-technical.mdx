...
src/
 components/
Ç    institutional/
Ç   Ç    UniversityScopedCMS.tsx          # Main CMS interface
Ç   Ç    cms/
Ç   Ç        UniversityOnboarding.tsx     # 7-step system
Ç   Ç        DemographicsManager.tsx      # Demographics with toggle
Ç   Ç        AcademicStructureManager.tsx # Faculties/schools
Ç   Ç        EmergencyServicesManager.tsx # Emergency resources
Ç   Ç        WellbeingContentLibrary.tsx  # Content management
Ç   Ç        ReportsAnalyticsConfig.tsx   # Reports system
Ç   Ç        AuthorizedUsersManager.tsx   # User management
Ç   Ç        ContentManager.tsx           # Article management
Ç   Ç        EmergencyResourcesManager.tsx # Emergency contacts
Ç    ui/                                  # Reusable UI components
Ç    UniversitySpecificLogin.tsx          # Authentication
 contexts/
Ç    AdminAuthContext.tsx                 # Authentication context
 services/
Ç    adminAuth.ts                         # Authentication service
 features/
Ç    cms/
Ç        data.ts                          # Data access layer
