...
**Status**: Shipped (Pro). University mirror planned.
**Domain**: `insight.mindmeasurepro.com`
**Repo**: `mind-measure-pro-insight-hub` (standalone Next.js app)
**Backend**: `mind-measure-pro-core` (`/api/companies/*` Conversational Insight endpoints)
