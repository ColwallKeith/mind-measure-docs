...
> **⚠️ DOCUMENTATION STATUS**: This document describes a Supabase-based implementation that may be outdated.
> 
> **Current Status**: The CMS is accessible at `admin.mindmeasure.co.uk/university/{slug}/cms` and uses AWS infrastructure (Aurora + Cognito) according to the [Architecture documentation](/architecture).
> 
...
> - [Architecture Overview](/architecture) - Current AWS infrastructure
> - [Database Documentation](/database) - Aurora PostgreSQL schema
> - [API Documentation](/api-documentation) - Current API endpoints
> 
