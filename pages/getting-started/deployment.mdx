...
1. **Mobile App** - Deployed to Vercel (mobile.mindmeasure.app)
2. **Admin Dashboard** - Deployed to Vercel (admin.mindmeasure.co.uk)
3. **Assessment Engine** - Deployed to AWS via CDK (API Gateway + Lambda)
